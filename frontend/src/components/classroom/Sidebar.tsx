         ...
         <div className={cn(
           ...
           {!collapsed && (
             <div className="flex-1 min-w-0">
               ...
               <p className="text-xs text-sidebar-foreground/60 truncate">Student</p>
             </div>
           )}
         </div>
         {!collapsed && (
           <Button variant="ghost" className="w-full mt-2 text-sidebar-foreground/70 hover:text-sidebar-foreground hover:bg-sidebar-accent">
