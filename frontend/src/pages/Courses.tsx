...
import { BookOpen, Users, Star, Play, ArrowRight, Filter, Search } from "lucide-react";
...
const Courses = () => {
  ...
  const handleContinueLearning = (title: string) => {
    toast.success(`Opening ${title}...`);
    navigate("/live"); // Redirecting to live as a placeholder for lesson view
  };
            ...
            {courses.map((course, index) => (
              ...
              >
                ...
                <div className="relative h-40 overflow-hidden">
                  ...
                  {/* Category Badge */}
                  <Badge className="absolute top-3 left-3 bg-white/90 text-foreground hover:bg-white cursor-pointer" onClick={() => toast.info(`Filtering by ${course.category}`)}>
                    {course.category}
                  </Badge>
