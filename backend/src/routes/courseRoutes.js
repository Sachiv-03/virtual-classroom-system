...
const { validateCourse, validateSchedule } = require('../middleware/validationMiddleware');
...
router.put('/:id', protect, authorize('teacher', 'admin'), validateCourse, courseController.updateCourse);
